    ...
    <main>
      <div className={`container ${styles.Home_content}`}>
        ...
        <div className={styles.main_home}>
          <AnimatedText text="Let's explore the art of web" classname="big-bold-text" />
        </div>
      </div>
      ...
      <motion.h2 initial={{opacity: 0, y:0}} viewport={{once: true}} whileInView={{opacity: 1, y:-20}} transition={{ duration: 0.8, delay: 1}} className="big-bold-text">
            Services
        </motion.h2>
      <Services/>
      </section>
